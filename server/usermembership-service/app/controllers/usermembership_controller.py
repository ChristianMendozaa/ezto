...
async def create_user_membership(membership: UserMembershipDTO):
...
async def delete_user_membership(membership_id: str):
...
async def update_user_membership_partial(membership_id: str, updates: Dict[str, Any] = Body(...)):
    """
